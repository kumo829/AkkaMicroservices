...
CREATE TABLE IF NOT EXISTS public.event_journal(ordering BIGSERIAL, persistence_id VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.event_tag(event_id BIGINT, tag VARCHAR(256),
